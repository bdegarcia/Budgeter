...
function saveRecord(offlineTransaction) {
  ...
  request.onsuccess = () => {
    ...
    const offlineTrans = transaction.objectStore("offlineTransactions");
    offlineTrans.add(offlineTransaction);
  };
}
...
function pushToDB() {
  ...
  request.onsuccess = () => {
    const db = request.result;
    const transaction = db.transaction(["offlineTransactions"], "readwrite");
    const offlineTransactions = transaction.objectStore("offlineTransactions");
    const getAll = offlineTransactions.getAll();
